...
::: column-margin
![An example of annealed distributions.](annealing.png){#fig-PT width="200"}
:::
...
::: column-margin
![Swap structure of PT algorithm.](PT.png){#fig-PT width="200"}
:::
...
::: column-margin
![SMC particle genealogy.](SMC.png){#fig-SMC width="150"}
:::
